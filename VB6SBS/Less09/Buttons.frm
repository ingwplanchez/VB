...
Begin VB.Form Form1 
   ...
   Begin VB.Image Image1 
      Height          =   330
      Left            =   1560
      Picture         =   "Buttons.frx":0C50
      Tag             =   "Up"
      Top             =   720
      Width           =   360
   End
   Begin VB.Label Label1 
      Caption         =   "Click the buttons to practice formatting the sample text."
      Height          =   255
      Left            =   480
      TabIndex        =   1
      Top             =   120
